...
import { checkLegitPaymentForScam } from '../api/fraud';
...
const RECIPIENT_NAME = 'Emma Bakker';
const RECIPIENT_IBAN = 'NL42 INGB 0005 4321 09';
const AMOUNT_EUROS = '42';
const AMOUNT_CENTS = '50';
const TOTAL_DISPLAY = '€42,50';

export function TransferLegitScreen({ onBack, onApproved, onBlocked }: Props) {
    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.memoCard}>
          ...
          <Text style={styles.memoText}>Pizza vrijdag</Text>
        </View>
        ...
        <View style={styles.feeRow}>
          ...
          <Text style={styles.totalValue}>{TOTAL_DISPLAY}</Text>
        </View>
